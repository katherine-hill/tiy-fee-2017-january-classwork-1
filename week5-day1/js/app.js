    ...
    $(document).ready(() => {
        const fetchLeague = function() {
            ...
            function generateTemplate(page) {
                ...
                // Convert that HTML string into a Handlebars function
                const template = Handlebars.compile(source);
                // console.log(template);

                // Empty because no dynamic information on home-template
                // Use context when passing custom details to each template
                const context = page !== 'home' ? dogs[page] : {};
                console.log(context);

                // Pass context into the template function created above
